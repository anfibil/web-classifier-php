...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2015 at 12:09 AM
...
(1, 1, '{"criterion":"entropy","splitter":"best","max_leaf_nodes":12,"min_samples_leaf":2,"max_features":8,"min_samples_split":3,"max_depth":20}', 0.373094211827, 1, 'user', 2, '{"auroc": 0.77913219506934428}'),
(2, 1, '{"criterion":"gini","splitter":"best","max_leaf_nodes":5,"min_samples_leaf":4,"max_features":3,"min_samples_split":32,"max_depth":20}', 0.335950720533, 1, 'user', 2, '{"auroc": 0.74479980675266866}'),
(3, 2, '[]', NULL, 0, 'user', 2, NULL),
(4, 3, '{"penalty":"none","fit_intercept":"true","n_iter":"5.00","shuffle":"true","eta0":"1.00","warm_start":"true"}', NULL, 0, 'user', 2, NULL),
(5, 3, '{"penalty":"none","fit_intercept":true,"n_iter":5,"shuffle":true,"eta0":1,"warm_start":true}', NULL, 0, 'user', 2, NULL),
(6, 3, '{"penalty":"none","fit_intercept":true,"n_iter":5,"shuffle":true,"eta0":1,"warm_start":true}', NULL, 0, 'user', 2, NULL),
(7, 3, '{"penalty":"none","fit_intercept":1,"n_iter":5,"shuffle":True,"eta0":1,"warm_start":1}', NULL, 0, 'user', 2, NULL);
...
(2, 'user', 'user', 'user@email.com', 'user@email.com', 1, 'av2sn0ujazkgcok4s004og8o40gss8w', '170IfD1qEs26TVFKqwr3G0tGJxBZgopmNHdMaOkHuy0k8J5E/rffVtWBGQvVH5/g/Gg2mgxpR5lqGRmaMSPitg==', '2015-04-02 17:40:44', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, 'FirstName', 'LastName', 'University of Notre Dame', '2015-04-02 17:40:44', '/assets/profilepictures/ee11cbb19052e40b07aac0ca060c23ee');
