...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2015 at 11:17 PM
...
(1, 'classification', '("criterion","splitter","max_features_for_split","max_leaf_nodes","min_samples_split","min_samples_leaf","max_depth")', 'Decision Tree', '<div class="row"><div class="col-lg-2 text-center"><label>Criterion:</label><div class="radio i-checks"><label><input type="radio"value="gini"name="criterion"checked=""class="required">Gini</label></div><div class="radio i-checks"><label><input type="radio"value="entropy"name="criterion"class="required">Entropy</label></div></div><div class="col-lg-2 text-center"><label>Splitter:</label><div class="radio i-checks"><label><input type="radio"value="best"name="splitter"checked=""class="required">Best</label></div><div class="radio i-checks"><label><input type="radio"value="random"name="splitter"class="required">Random</label></div></div><div class="col-lg-4 text-center"><label>Grow a tree with<i>max_leaf_nodes</i>in best-first fashion:&nbsp&nbsp<i>max_leaf_nodes</i>=<span class="example-val"style="color:#1AB394"id="max_leaf_nodes-value"></span></label><div class="col-lg-10 col-lg-offset-1"><div id="max_leaf_nodes-slider"></div><input type="hidden"name="max_leaf_nodes"id="max_leaf_nodes"value=""><br/></div></div><div class="col-lg-4 text-center"><label>Minimum number of samples required to be at a leaf node:&nbsp&nbsp<i>min_samples_leaf</i>=<span class="example-val"style="color:#1AB394"id="min_samples_leaf-value"></span></label><div class="col-lg-10 col-lg-offset-1"><div id="min_samples_leaf-slider"></div><input type="hidden"name="min_samples_leaf"id="min_samples_leaf"value=""></div></div></div><div class="hr-line-dashed"></div><div class="row"><div class="col-lg-4 text-center"><label>Number of features to consider when looking for the best split:&nbsp&nbsp<i>max_features_for_split</i>=<span class="example-val"style="color:#1AB394"id="max_features_for_split-value"></span></label><div class="col-lg-10 col-lg-offset-1"><div id="max_features_for_split-slider"></div><input type="hidden"name="max_features_for_split"id="max_features_for_split"value=""><br/></div></div><div class="col-lg-4 text-center"><label>Minimum number of samples required to split an internal node:&nbsp&nbsp<i>min_samples_split</i>=<span class="example-val"style="color:#1AB394"id="min_samples_split-value"></span></label><div class="col-lg-10 col-lg-offset-1"><div id="min_samples_split-slider"></div><input type="hidden"name="min_samples_split"id="min_samples_split"value=""></div></div><div class="col-lg-4 text-center"style="display:inline-block; vertical-align: middle; float: none; margin-right:-4px;"><label>Maximum depth of the tree:&nbsp&nbsp<i>max_depth</i>=<span class="example-val"style="color:#1AB394"id="max_depth-value"></span></label><div class="col-lg-10 col-lg-offset-1"><div id="max_depth-slider"></div><input type="hidden"name="max_depth"id="max_depth"value=""></div></div></div><div class="hr-line-dashed"></div><script>$(document).ready(function(){$(''.i-checks'').iCheck({checkboxClass:''icheckbox_square-green'',radioClass:''iradio_square-green'',});$(''#max_features_for_split-slider'').noUiSlider({start:[3],step:1,connect:"lower",range:{''min'':[1],''max'':[20]}});$(''#max_features_for_split-slider'').Link(''lower'').to($(''#max_features_for_split-value''));$(''#max_features_for_split-slider'').Link(''lower'').to($(''#max_features_for_split''));$(''#min_samples_split-slider'').noUiSlider({start:[3],step:1,connect:"lower",range:{''min'':[1],''max'':[20]}});$(''#min_samples_split-slider'').Link(''lower'').to($(''#min_samples_split-value''));$(''#min_samples_split-slider'').Link(''lower'').to($(''#min_samples_split''));$(''#max_leaf_nodes-slider'').noUiSlider({start:[3],step:1,connect:"lower",range:{''min'':[1],''max'':[20]}});$(''#max_leaf_nodes-slider'').Link(''lower'').to($(''#max_leaf_nodes-value''));$(''#max_leaf_nodes-slider'').Link(''lower'').to($(''#max_leaf_nodes''));$(''#min_samples_leaf-slider'').noUiSlider({start:[3],step:1,connect:"lower",range:{''min'':[1],''max'':[20]}});$(''#min_samples_leaf-slider'').Link(''lower'').to($(''#min_samples_leaf-value''));$(''#min_samples_leaf-slider'').Link(''lower'').to($(''#min_samples_leaf''));$(''#max_depth-slider'').noUiSlider({start:[3],step:1,connect:"lower",range:{''min'':[1],''max'':[20]}});$(''#max_depth-slider'').Link(''lower'').to($(''#max_depth-value''))$(''#max_depth-slider'').Link(''lower'').to($(''#max_depth''))});</script>'),
...
(2, 'user', 'user', 'user@email.com', 'user@email.com', 1, 'av2sn0ujazkgcok4s004og8o40gss8w', '170IfD1qEs26TVFKqwr3G0tGJxBZgopmNHdMaOkHuy0k8J5E/rffVtWBGQvVH5/g/Gg2mgxpR5lqGRmaMSPitg==', '2015-03-27 18:46:44', 0, 0, NULL, NULL, NULL, 'a:0:{}', 0, NULL, 'FirstName', 'LastName', 'University of Notre Dame', '2015-03-27 18:46:44', '/assets/profilepictures/ee11cbb19052e40b07aac0ca060c23ee');
